...
+:=======================+:=================================+:===================================+:=======================================+
| 9:00 - 10:30 am        | [\-]{.tcenter}                   | Activity 1 Recap                   | **Lecture 4:** Overview of Model       |
|                        |                                  |                                    | Evaluation                             |
|                        |                                  | **Lecture 3:** Prompting           |                                        |
|                        |                                  |                                    |                                        |
|                        |                                  | **Activity 2:** Interactive        |                                        |
|                        |                                  | Activity & `rules.md` Files        |                                        |
|                        |                                  | *(begins)*                         |                                        |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 10:30 - 11:00 am       | [*-*]{.tcenter}                  | *Break*                            | *Break*                                |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 11:00 - 12:30 pm       | [\-]{.tcenter}                   | **Activity 2:** Interactive        | **Activity 4:** Model Evaluation       |
|                        |                                  | Activity & `rules.md` Files        |                                        |
|                        |                                  | *(continued)*                      |                                        |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 12:30 - 1:30 pm        | [*-*]{.tcenter}                  | *Lunch Break*                      | *Lunch Break*                          |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 1:30 - 3:00 pm         | Introductions                    | **Lab Lecture 2:** Forecasting     | **Lecture 5:** AI/HAT Evaluation &     |
|                        |                                  |                                    | Working with AI for Refinement         |
|                        | **Lecture 1:** Overview of       | **Activity 3:** Forecasting Lab    |                                        |
|                        | Forecasting                      |                                    | **Activity 5:** Refining Models        |
|                        |                                  |                                    |                                        |
|                        | **Lecture 2:** Introduction to   |                                    |                                        |
|                        | AI and Human-AI Teaming          |                                    |                                        |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 3:00 - 3:30 pm         | *Break*                          | *Break*                            | *Break*                                |
+------------------------+----------------------------------+------------------------------------+----------------------------------------+
| 3:30 - 5:00 pm         | **Lab Lecture 1:** Introduction  | **Activity 3:** Forecasting Lab    | Free-Coding, Questions & Wrap-Up       |
|                        | to GitHub, VS Code & Set Up      | *(continued)*                      |                                        |
|                        |                                  |                                    |                                        |
